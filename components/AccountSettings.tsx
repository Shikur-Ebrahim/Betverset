    ...
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-[var(--site-surface)] w-full h-[92vh] sm:h-auto sm:max-w-md rounded-t-[32px] sm:rounded-[32px] overflow-hidden shadow-2xl animate-in slide-in-from-bottom duration-300 flex flex-col">
        <header className="bg-[var(--site-surface)] px-6 py-6 flex items-center justify-between border-b border-[var(--site-border)] shrink-0">
          <div className="text-2xl font-black text-slate-900 tracking-tighter">Account settings</div>
        ...
        <main className="flex-1 overflow-y-auto p-6 pb-20">
          <div className="mb-8">
            ...
            <div className="text-lg font-black text-slate-900">{user?.phone}</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                type="password" 
                required
                className="w-full bg-[var(--site-surface-soft)] border-2 border-transparent rounded-[20px] px-5 py-4 font-bold text-slate-900 focus:bg-[var(--site-surface)] focus:border-orange-500 outline-none transition-all"
