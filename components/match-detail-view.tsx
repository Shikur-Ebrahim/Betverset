...
function renderStatusBadge(fixture: Fixture) {
  ...
  if (isMatchClosedForBetting(fixture)) {
    return (
      <span className="mt-2.5 bg-[#1E293B]/10 border border-[#334155]/20 text-[#94A3B8] text-[9px] px-2.5 py-1 rounded-sm font-black uppercase tracking-widest backdrop-blur-sm whitespace-nowrap">
        Finished
      </span>
    );
  }
...
export default function MatchDetailView({ initialFixture, initialOdds, oddsLoading = false }: Props) {
  ...
  return (
    <div className="site-shell bg-[#1E293B] min-h-screen text-white pb-[70px]">
      <AuthModal
        isOpen={isAuthOpen}
      ...
      <header className="flex items-center h-14 px-4 bg-[#1E293B] border-b border-[#334155] sticky top-0 z-40">
        <Link href="/" className="text-[#94A3B8] p-2 -ml-2">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="px-4 py-3 text-[11px] text-[#94A3B8] flex items-center gap-1.5 font-bold uppercase tracking-widest">
        <span>Football</span>
        ...
        <div className="relative px-5 py-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col items-center gap-2.5 w-[35%]">
              <div className="w-[60px] h-[60px] bg-[#1E293B]/10 rounded-full flex items-center justify-center border border-[#FFFFFF]/20 p-2.5 shadow-inner">
      ...
      <nav className="fixed bottom-0 left-0 right-0 h-[64px] bg-[#1E293B] border-t border-[#334155] flex justify-around items-center z-50">
        ...
        <Link href="/" prefetch={false} className="flex flex-col items-center gap-1 text-[#94A3B8] hover:text-white transition-colors">
          <svg
            className="w-6 h-6"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <Link href="/check-ticket" prefetch={false} className="flex flex-col items-center gap-1 text-[#94A3B8] hover:text-white transition-colors">
          <svg
            className="w-6 h-6"
            viewBox="0 0 24 24"
            fill="none"
